...
export const initData = (dataProp, height, gap, numberOfPoints = 5, customGuideArray) => {
  ...
  guideArray = customGuideArray ? customGuideArray(max, height, numberOfPoints) : getGuideArray(max, height, numberOfPoints)
